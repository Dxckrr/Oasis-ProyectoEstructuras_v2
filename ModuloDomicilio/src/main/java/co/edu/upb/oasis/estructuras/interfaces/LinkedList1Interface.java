...
public interface LinkedList1Interface<T extends Serializable> extends Serializable{
     ...
     */
    public LinkedList1Interface<T> cloneList();
     ...
     */
    public LinkedList1Interface<T> subList(NodeInterface<T> from, NodeInterface<T> to);
