...
public class DoubleLinkedList<T extends Serializable> implements DoubleLinkedListInterface<T> {
    ...
    public DoubleLinkedList<T> cloneList() {
        Iterator<NodeInterface<T>> iterator = iterator();
        DoubleLinkedList<T> linkedListClone = new DoubleLinkedList<>();
        while (iterator.hasNext()) {
    ...
    public DoubleLinkedListInterface<T> subList(NodeInterface<T> from, NodeInterface<T> to) {
        if ((validateNodes(from, to)) && (!isEmpty())) {
            try {
                Iterator<NodeInterface<T>> iterator = iterator();
                DoubleLinkedList<T> linkedListToReturn = new DoubleLinkedList<T>();
                while (iterator.hasNext()) {
   ...
   /* public boolean sortObjectsByK(int k) {
    ...
    public DoubleLinkedList<T> reverseAll(DoubleLinkedList<T> list) {
    ...
    public DoubleLinkedList<Pedido> getHead() {
        return null;
    }
    ...
    public DoubleLinkedList<Pedido> getNext() {
        return null;
    }
